...
class BoxRoomController extends Controller
{
    public function index()
    {
        ...
        $properties = Proparty::with('propertytype')->with('images')->where('is_publish', 1)->where('is_complete', 1)->orderBy('updated_at', 'desc')->limit(6)->get();
    ...
    {   
        $properties = Proparty::with('propertytype')->with('images')->where('is_publish', 1)->where('is_complete', 1)->orderBy('updated_at', 'desc')->paginate(6);
