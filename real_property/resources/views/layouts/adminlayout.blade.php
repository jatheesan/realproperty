            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a href="" class="collapse-item" data-toggle="modal" data-target="#loginModal">{{ __('Sign In') }}</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action="{{ route('properties.property.search') }}" method="POST" role="search"
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="search_pro"
                                placeholder="Search for property..."><span class="input-group-btn">
                    ...
                    <ul class="navbar-nav ml-auto">
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-org" type="button">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->image) }}" alt="iHOMES">
                            </a>
