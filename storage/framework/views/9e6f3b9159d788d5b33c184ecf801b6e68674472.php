...
<head>
    ...
    <title><?php echo e(config('app.name', 'Real Property')); ?></title>
    ...
    <link href="<?php echo e(asset('vendor/owl.carousel/assets/owl.carousel.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand text-brand" href="<?php echo e(url('/')); ?>">Real<span class="color-b">Property</span></a>
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/aboutus')); ?>">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/properties')); ?>">Property</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/contactus')); ?>">Contact</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <nav class="nav-footer">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <a href="<?php echo e(url('/properties')); ?>">Property</a>
                            </li>
                            <li class="list-inline-item">
...
<?php /**PATH C:\xampp\htdocs\laravel\project\realproperty\resources\views/layouts/applayout.blade.php ENDPATH**/ ?>